...
import { EMemberRole, TMember, TUser, WorkspaceStatus } from '../../../../types'
import MemberControl from '../../MemberControl'
import { TCreateChildForm } from './CreateTeamChild'
...
export const Members = memo(
  ({ control }: { control: Control<TCreateChildForm, any> }) => {
